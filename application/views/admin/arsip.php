                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $ars->tanggal_dokumen ? date('d-m-Y', strtotime($ars->tanggal_dokumen)) : '-'; ?></td>
                                        <td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Tanggal Dokumen</label>
                        <input type="date" class="form-control" name="tanggal_dokumen" value="<?php echo $ars->tanggal_dokumen ? date('Y-m-d', strtotime($ars->tanggal_dokumen)) : ''; ?>">
                    </div>
                    <div class="form-group">
                        <label>Pembuat</label>
